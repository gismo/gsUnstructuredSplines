/** @file kirchhoff-Love_multipatch_vibration_example_XML.cpp

    @brief Multi-patch vibration analysis of Kirchhoff-Love using gsUnstructuredSplines with XML input
